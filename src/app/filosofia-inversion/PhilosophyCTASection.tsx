...
const PhilosophyCTASection = () => {
  ...
  const officeHours = (
    <div className="space-y-1 text-sm">
      <p><strong className="font-medium">Lunes a Viernes:</strong> 9:00 AM - 6:00 PM</p>
      <p><strong className="font-medium">Sábado:</strong> 10:00 AM - 2:00 PM</p>
      <p><strong className="font-medium">Domingo:</strong> Cerrado</p>
    </div>
  );
    ...
    <section className="py-16 md:py-24 bg-[#efefef] w-full">
      <div className={`mx-auto ${SHARED_MAX_WIDTH_CLASS} ${SHARED_HORIZONTAL_PADDING_CLASSES} text-center`}>
        ...
        <p className="text-lg md:text-xl text-(--color-primary) max-w-2xl mx-auto mb-8 md:mb-10">
          Permítenos explicarte personalmente nuestra estrategia. Contáctanos durante {" "} 
          <Popover>
            ...
            <PopoverContent className="w-auto p-4 bg-white shadow-md rounded-lg border">
              ...
              <div className="text-left">
                <h4 className="font-bold text-md mb-2 text-(--color-primary)">Horario de Atención</h4>
                {officeHours}
              </div>
            </PopoverContent>
          </Popover>; 
