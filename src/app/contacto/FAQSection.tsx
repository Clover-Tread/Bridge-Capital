...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from "@/components/ui/accordion"; // Importa desde ShadCN UI
...
// Datos para el FAQ - Necesitarás completar las respuestas
const faqData = [
  {
    id: "faq-1",
  ...
  },
  {
    ...
    answer: "Nuestros servicios están disponibles para: Personas Físicas, Personas Morales, Fideicomisos, y Entidades Gubernamentales. [cite: 6]",
  },
  {
    id: "faq-3",
    question: "¿Cuánto es el monto mínimo para invertir?",
    answer: "El monto mínimo para comenzar a invertir es desde $5,000,000.00 de pesos. [cite: 6]",
  },
  {
    id: "faq-4",
    question: "¿Qué hace Bridge Capital?",
    answer: "Bridge Capital te ayuda a alcanzar tus metas construyendo un portafolio de inversión a tu medida, buscando invertir tu patrimonio en empresas con ventajas competitivas durables que generen valor a lo largo de los años, no de meses o días. [cite: 6]",
  },
  {
    id: "faq-5",
    question: "¿Cuáles son los documentos para ser cliente de Bridge Capital?",
    answer: "Si eres persona física, se requieren: Identificación Oficial Vigente (IFE/INE/Pasaporte), Comprobante de Domicilio no mayor a 3 meses (recibo de luz, agua, telefonía fija, predial), Cédula RFC, CURP, Carátula y hoja donde viene el sello digital de estado de cuenta bancario que se quiera registrar para los retiros de dinero. [cite: 6]\n\nSi eres persona moral, se requieren: Acta Constitutiva con sello de registro público de comercio, Poderes de las personas que firmarán dentro de la cuenta con sello de registro público de comercio, Cédula RFC de la empresa, Comprobante de domicilio de la empresa, Identificaciones Oficiales Vigentes de los apoderados (INE/Pasaporte), Cédula RFC de los apoderados. [cite: 6]",
  },
  {
    id: "faq-6",
    question: "¿Cómo cobra Bridge Capital?",
    answer: "Los honorarios de Bridge Capital se dividen en dos: Comisión por Administración de Activos (\"Management Fee\"), que es un porcentaje fijo mensual sobre los activos administrados, y una Comisión por Resultados (\"Success Fee\"), que es un premio si se generan rendimientos positivos por encima de un rendimiento base pactado anualmente. [cite: 6]",
  },
  {
    id: "faq-7",
    question: "¿Dónde estaría mi dinero?",
    answer: "Tu dinero estará siempre resguardado en una cuenta de inversión a tu nombre en alguna de las instituciones financieras reconocidas. Nosotros solo te ayudamos a decidir en qué negocio invertirlo. [cite: 6]",
  },
];
      ...
      <div className={`mx-auto ${SHARED_MAX_WIDTH_CLASS} ${SHARED_HORIZONTAL_PADDING_CLASSES}`}>
        <div className="text-center mb-10 md:mb-12">
          <h3 className="text-3xl md:text-4xl text-(--color-primary))">
            <span className='text-3xl md:text-6xl font-[800] mb-4'>¿Tienes dudas?</span> <br /><span className='text-3xl font-[500]'>Revisa nuestras preguntas frecuentes</span>
          </h3>
        </div>
