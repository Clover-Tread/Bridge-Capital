...
const CONTENT_PADDING_TOP_CLASS = "pt-16";

const PreContactFormCTASection = () => {
  const backgroundImageFilename = "llamando.jpg";
  ...
  return (
    <section className="relative w-full py-12 md:py-20 text-white overflow-hidden">
